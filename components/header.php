...
<head>
    ...
    <?php if ($urlAtual === 'http://localhost/minha_loja/categoria' || $urlAtual === 'http://localhost/minha_loja/produtos' || $urlAtual === 'http://localhost/minha_loja/pesquisa' || $urlAtual === 'http://localhost/minha_loja/detalhes') { ?>
