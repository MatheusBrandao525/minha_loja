...
<section class="benefits-bar visible-md visible-lg">
  <div class="container_marisa_bene m-t-20">
    <div class="flexBeneficios"><!-- <div class="benefit-item col-md-1"></div> -->


      <div class="benefit-item">
        <div class="benefit-title pull-left"><img src="https://images2.marisa.com.br/medias/sys_master/images/images/h7c/h5d/15252102610974/20221020-ICON-FRETE.png" class="benefit-icon" alt=""></div>
        <div class="benefit-description">
          <h3>
            <div class="benefit-titulo" data-toggle="modal" data-target=".modalFrete">Frete Fixo*</div>
            <div class="benefit-titulo2" data-toggle="modal" data-target=".modalFrete">em todo Brasil</div>
          </h3>
        </div>
